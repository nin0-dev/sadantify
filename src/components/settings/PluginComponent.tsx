...
import { ButtonTertiary, getToggleComponent, React, Text } from "@webpack/common";
        ...
        <div className="ext-plugin">
            ...
            <div className="ext-plugin-header">
                ...
                <ButtonTertiary
                    ...
                    iconOnly={
                        () => props.plugin.settings || props.plugin.options ? <CogIcon /> : <InfoIcon />
                    }
